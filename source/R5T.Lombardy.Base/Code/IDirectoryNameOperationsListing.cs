...
namespace R5T.Lombardy.Base
{
    ...
    /// This interface is *not* meant to be implemented, but instead serve as a clear, single listing of all directory name operations that are in reality spread throughout interfaces, interface extension methods, and static classes, implementation classes, and riddled with comments making direct visual comparison difficult.
    /// </summary>
